...
<body>
  ...
  <section class="hero is-medium title-banner">
    <div class="hero-body">
      <div class="container">
        ...
        <h2 class="subtitle">Terms of Use</h2>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Use of the Service</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Prohibited Use</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Content</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Online Behaviour</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">No Content Monitoring</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Termination of Access</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Privacy</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Our Properitary Rights</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">No Warranties</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Idemnity</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Jurisdiction and Governing Law</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Severability</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Waiver; Remedies</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Contact Information</h1>
        <p>
  ...
  <section class="section content-block">
    <div class="container">
      <div>
        <h1 class="title is-5">Effective Date</h1>
        <p>
          These Terms of Use were last updated on 6th November, 2017.
        </p>
      </div>
    </div>
  </section>
