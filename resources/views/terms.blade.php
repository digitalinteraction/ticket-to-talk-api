...
<body>
    ...
    <div id="title-block" class="row">
        ...
        <div class="container">
    		<div id="title-bar" class="row">
    			...
    			<h3 class="col s12 center-align">Terms of Use</h3>
    		</div>
    	</div>
    ...
    <div id="info" class="row">
        <div id="about" class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Use of the Service</h3>
        ...
        <div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Prohibited Use</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Content</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Online Behaviour</h3>
            <div class="col l8 m12 info-box-text">
                <p>
				...
				<p>
					If you wish to report any Content or conduct on the Service that you believe is inappropriate, please contact us at d.welsh@ncl.ac.uk.
				</p>
            </div>
        </div>

		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">No Content Monitoring</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Termination of Access</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Privacy</h3>
            <div class="col l8 m12 info-box-text">
                <p>
                    The privacy of your personally identifiable information is very important to us. For more information on what information we collect and how we use such information, please read our Privacy Policy at http://ticket-to-talk.com/privacy
                </p>
            </div>
        </div>

		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Links</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Our Properitary Rights</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">No Warranties</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Idemnity</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Jurisdiction and Governing Law</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Severability</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Waiver; Remedies</h3>
            <div class="col l8 m12 info-box-text">
                <p>
		...
		<div class="info-box row">
            <h3 class="info-box-header col l2 offset-l1 s12">Contact Information</h3>
            <div class="col l8 m12 info-box-text">
                <p>
					Should you have any questions, you may contact us at d.welsh@ncl.ac.uk.
				</p>
            </div>
        </div>
		...
		<div class="info-box row">
            ...
            <div class="col l8 m12 info-box-text">
                <p>
					These Terms of Use were last updated on 31th May 2017.
				</p>
            </div>
        </div>
    </div>
